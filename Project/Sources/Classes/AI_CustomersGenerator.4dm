...
singleton Class constructor()
	...
	This.responseData:=""
	$addressExpectedSchema:={streetNumber: "number as string"; streetName: "street name as string"; apartment: "number as string"; building: "building as string"; poBox: "po box"; city: "city as string"; region: "region as string"; postalCode: "postal code as string"; country: "country as string"}
...
Function prompt()
	...
	$prompt:="generate "+String($toGenerate)+" customers. Start answering with ```json\n["
